...
VALUES
  -- CLOSED WON (Vinte)
  ('('b1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'TechFlow - Pacchetto Enterprise 500 Leads B2B Tech', 15000.00, 'EUR', 'closed_won', 100, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '60 days', 'partner', 'a1111111-1111-1111-1111-111111111111', NOW() - INTERVAL '90 days', NOW() - INTERVAL '60 days'),
  
  ('('b2222222-2222-2222-2222-222222222221', '22222222-2222-2222-2222-222222222222', 'Digital Boost - Leads Marketing Agencies Qualified', 8500.00, 'EUR', 'closed_won', 100, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '45 days', 'organic', NULL, NOW() - INTERVAL '120 days', NOW() - INTERVAL '45 days'),
  
  ('('b5555555-5555-5555-5555-555555555551', '55555555-5555-5555-5555-555555555555', 'BGConsultants - Database PMI Manufacturing 300 Leads', 5500.00, 'EUR', 'closed_won', 100, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '180 days', 'cold_outreach', NULL, NOW() - INTERVAL '200 days', NOW() - INTERVAL '180 days'),
  
  -- NEGOTIATION (In Negoziazione)
  ('('b3333333-3333-3333-3333-333333333331', '33333333-3333-3333-3333-333333333333', 'Prime Properties - Leads Acquirenti Immobili Luxury 1000 Contatti', 25000.00, 'EUR', 'negotiation', 75, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '15 days', 'ads', 'a2222222-2222-2222-2222-222222222222', NOW() - INTERVAL '150 days', NOW() - INTERVAL '5 days'),
  
  ('('b4444444-4444-4444-4444-444444444441', '44444444-4444-4444-4444-444444444444', 'ShopItaly - E-commerce Leads + Retargeting Data 5000 Leads', 18000.00, 'EUR', 'negotiation', 80, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '20 days', 'referral', NULL, NOW() - INTERVAL '45 days', NOW() - INTERVAL '3 days'),
  
  -- PROPOSAL (Proposta Inviata)
  ('('b6666666-6666-6666-6666-666666666661', '66666666-6666-6666-6666-666666666666', 'FinTech Innovations - Qualified Leads Fintech Startups 800 Leads', 22000.00, 'EUR', 'proposal', 60, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '30 days', 'event', 'a3333333-3333-3333-3333-333333333333', NOW() - INTERVAL '15 days', NOW() - INTERVAL '2 days'),
  
  -- DISCOVERY (In Scoperta)
  ('('b7777777-7777-7777-7777-777777777771', '77777777-7777-7777-7777-777777777777', 'HealthCare Solutions - Medical Facilities Decision Makers 600 Leads', 16000.00, 'EUR', 'discovery', 40, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '45 days', 'organic', NULL, NOW() - INTERVAL '8 days', NOW() - INTERVAL '1 day'),
  
  -- QUALIFYING (In Qualifica)
  ('('b8888888-8888-8888-8888-888888888881', '88888888-8888-8888-8888-888888888888', 'EduTech Academy - Students & Parents Database 2000 Leads', 9500.00, 'EUR', 'qualifying', 30, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '60 days', 'ads', NULL, NOW() - INTERVAL '3 days', NOW() - INTERVAL '6 hours'),
  
  -- NEW (Nuova)
  ('('b2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'Digital Boost - Expansion: LinkedIn Leads Campaign 1500 Leads', 12000.00, 'EUR', 'new', 20, '00000000-0000-0000-0000-000000000002', NOW() + INTERVAL '90 days', 'organic', NULL, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
  
  -- CLOSED LOST (Persa)
  ('('b9999999-9999-9999-9999-999999999991', '44444444-4444-4444-4444-444444444444', 'ShopItaly - Previous Proposal: Basic Package 200 Leads', 3500.00, 'EUR', 'closed_lost', 0, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '50 days', 'cold_outreach', NULL, NOW() - INTERVAL '80 days', NOW() - INTERVAL '50 days')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('of111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', 1, 
  ...
  ('of222222-2222-2222-2222-222222222221', '('b2222222-2222-2222-2222-222222222221', 1,
  ...
  ('of333333-3333-3333-3333-333333333331', '('b3333333-3333-3333-3333-333333333331', 1,
  ...
  ('of333333-3333-3333-3333-333333333332', '('b3333333-3333-3333-3333-333333333331', 2,
  ...
  ('of444444-4444-4444-4444-444444444441', '('b4444444-4444-4444-4444-444444444441', 1,
...
VALUES
  ...
  ('ct111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', 'of111111-1111-1111-1111-111111111111', NULL, 'signed', NOW() - INTERVAL '60 days', 'AYCL-2024-001', NOW() - INTERVAL '65 days', NOW() - INTERVAL '60 days'),
  
  -- Contratto Digital Boost (Firmato)
  ('ct222222-2222-2222-2222-222222222221', '22222222-2222-2222-2222-222222222222', '('b2222222-2222-2222-2222-222222222221', 'of222222-2222-2222-2222-222222222221', NULL, 'signed', NOW() - INTERVAL '45 days', 'AYCL-2024-002', NOW() - INTERVAL '50 days', NOW() - INTERVAL '45 days'),
  
  -- Contratto BGConsultants (Firmato)
  ('ct555555-5555-5555-5555-555555555551', '55555555-5555-5555-5555-555555555555', '('b5555555-5555-5555-5555-555555555551', NULL, NULL, 'signed', NOW() - INTERVAL '180 days', 'AYCL-2023-045', NOW() - INTERVAL '185 days', NOW() - INTERVAL '180 days'),
  
  -- Contratto Prime Properties (In attesa di firma)
  ('ct333333-3333-3333-3333-333333333331', '33333333-3333-3333-3333-333333333333', '('b3333333-3333-3333-3333-333333333331', 'of333333-3333-3333-3333-333333333332', NULL, 'pending', NULL, 'AYCL-2024-003', NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  -- Pagamento TechFlow
  ('py111111-1111-1111-1111-111111111111', 'in111111-1111-1111-1111-111111111111', 'ct111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 'succeeded', 'bank_transfer', 15000.00, 'EUR', 'BT-2024-001-TF', '{}'::jsonb, NOW() - INTERVAL '28 days', NOW() - INTERVAL '28 days'),
...
-- ============================================
-- 12. ACTIVITIES (Attività CRM)
-- ============================================

INSERT INTO activities (id, type, actor_id, company_id, contact_id, opportunity_id, content, metadata, occurred_at, created_at)
VALUES
  -- Email activities
  ('ac111111-1111-1111-1111-111111111111', 'email', '00000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', 'Inviata proposta commerciale per pacchetto Enterprise 500 Leads B2B Tech. Allegato: AYCL-Proposal-TechFlow-v1.pdf', '{"subject":"Proposta Commerciale - 500 Leads B2B Tech Qualified","status":"sent"}'::jsonb, NOW() - INTERVAL '85 days', NOW() - INTERVAL '85 days'),
  
  ('ac222222-2222-2222-2222-222222222221', 'email', '00000000-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222', 'c2222222-2222-2222-2222-222222222221', '('b2222222-2222-2222-2222-222222222221', 'Follow-up email dopo demo piattaforma. Francesca interessata, richiesto sconto 10%.', '{"subject":"Re: Demo AYCL Platform - Marketing Leads","status":"sent"}'::jsonb, NOW() - INTERVAL '115 days', NOW() - INTERVAL '115 days'),
  
  ('ac666666-6666-6666-6666-666666666661', 'email', '00000000-0000-0000-0000-000000000002', '66666666-6666-6666-6666-666666666666', 'c6666666-6666-6666-6666-666666666661', '('b6666666-6666-6666-6666-666666666661', 'Inviata proposta FinTech Innovations. Elena ha chiesto dettagli su data compliance e GDPR.', '{"subject":"Proposta Leads Fintech + Compliance Details","status":"sent"}'::jsonb, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
  
  -- Call activities
  ('ac111112-1111-1111-1111-111111111112', 'call', '00000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', 'Call con Marco Rossi. Discussi termini contratto, confermato budget 15K, firma prevista entro fine settimana. Outcome: Positivo, deal closing.', '{"duration_minutes":45,"outcome":"positive"}'::jsonb, NOW() - INTERVAL '62 days', NOW() - INTERVAL '62 days'),
  
  ('ac333333-3333-3333-3333-333333333331', 'call', '00000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333', 'c3333333-3333-3333-3333-333333333331', '('b3333333-3333-3333-3333-333333333331', 'Negoziazione con Andrea Gallo. Richiesto sconto su offerta iniziale. Proposto 25K invece di 28K con supporto post-vendita incluso.', '{"duration_minutes":60,"outcome":"negotiating"}'::jsonb, NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days'),
  
  ('ac777777-7777-7777-7777-777777777771', 'call', '00000000-0000-0000-0000-000000000002', '77777777-7777-7777-7777-777777777777', 'c7777777-7777-7777-7777-777777777771', '('b7777777-7777-7777-7777-777777777771', 'Prima call con Giulia Moretti - HealthCare Solutions. Interessati a leads per medical facilities. Budget stimato 15-20K. Prossimo step: inviare case study.', '{"duration_minutes":30,"outcome":"qualified"}'::jsonb, NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days'),
  ...
  ('ac666666-6666-6666-6666-666666666662', 'meeting', '00000000-0000-0000-0000-000000000002', '66666666-6666-6666-6666-666666666666', 'c6666666-6666-6666-6666-666666666661', '('b6666666-6666-6666-6666-666666666661', 'Webinar "Lead Generation per Fintech" - Elena Fontana partecipante. Ottima impression, richiesto follow-up per discutere case study specifici.', '{"platform":"zoom","event_type":"webinar","attendees_count":45}'::jsonb, NOW() - INTERVAL '15 days', NOW() - INTERVAL '15 days'),
  
  -- Note activities
  ('ac555555-5555-5555-5555-555555555551', 'note', '00000000-0000-0000-0000-000000000002', '55555555-5555-5555-5555-555555555555', 'c5555555-5555-5555-5555-555555555551', '('b5555555-5555-5555-5555-555555555551', 'Cliente molto soddisfatto. Database PMI Manufacturing ha generato 23 nuovi contatti qualificati in 2 settimane. Possibile upsell futuro per database settore diverso.', '{}'::jsonb, NOW() - INTERVAL '170 days', NOW() - INTERVAL '170 days'),
  
  ('ac888888-8888-8888-8888-888888888881', 'note', '00000000-0000-0000-0000-000000000002', '88888888-8888-8888-8888-888888888888', 'c8888888-8888-8888-8888-888888888881', '('b8888888-8888-8888-8888-888888888881', 'Davide Greco trovato su LinkedIn ads campaign. Risposto a form contatto, interessato ma budget limitato. Max 10K. Da qualificare meglio.', '{"lead_source":"linkedin_ads","campaign":"Q4-Education-2024"}'::jsonb, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days'),
  
  -- System activities
  ('ac111113-1111-1111-1111-111111111113', 'system', NULL, '11111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', 'Opportunità spostata in stage "Closed Won". Valore: €15,000', '{"stage_from":"negotiation","stage_to":"closed_won","value":15000}'::jsonb, NOW() - INTERVAL '60 days', NOW() - INTERVAL '60 days'),
  
  ('ac222223-2222-2222-2222-222222222223', 'system', NULL, '22222222-2222-2222-2222-222222222222', 'c2222222-2222-2222-2222-222222222221', '('b2222222-2222-2222-2222-222222222221', 'Contratto firmato. Documento: AYCL-2024-002.pdf', '{"contract_id":"ct222222-2222-2222-2222-222222222221","status":"signed"}'::jsonb, NOW() - INTERVAL '45 days', NOW() - INTERVAL '45 days')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  -- File TechFlow
  ('fl111111-1111-1111-1111-111111111111', 'AYCL-Proposal-TechFlow-Enterprise-v1.pdf', 'application/pdf', 524288, '/files/proposals/AYCL-Proposal-TechFlow-v1.pdf', ARRAY['proposal','techflow','enterprise'], '11111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '85 days'),
  
  ('fl111112-1111-1111-1111-111111111112', 'Contract-TechFlow-AYCL-2024-001-signed.pdf', 'application/pdf', 786432, '/files/contracts/AYCL-2024-001-signed.pdf', ARRAY['contract','signed','techflow'], '11111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', 'ct111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '60 days'),
  
  ('fl111113-1111-1111-1111-111111111113', 'TechFlow-Leads-Sample-50records.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 102400, '/files/samples/techflow-sample-leads.xlsx', ARRAY['sample','leads','techflow'], '11111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '87 days'),
  
  -- File Digital Boost
  ('fl222221-2222-2222-2222-222222222221', 'AYCL-Proposal-DigitalBoost-v1.pdf', 'application/pdf', 612352, '/files/proposals/AYCL-Proposal-DigitalBoost-v1.pdf', ARRAY['proposal','digitalboost','marketing'], '22222222-2222-2222-2222-222222222222', '('b2222222-2222-2222-2222-222222222221', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '117 days'),
  
  ('fl222222-2222-2222-2222-222222222222', 'Contract-DigitalBoost-AYCL-2024-002-signed.pdf', 'application/pdf', 698304, '/files/contracts/AYCL-2024-002-signed.pdf', ARRAY['contract','signed','digitalboost'], '22222222-2222-2222-2222-222222222222', '('b2222222-2222-2222-2222-222222222221', 'ct222222-2222-2222-2222-222222222221', '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '45 days'),
  
  -- File Prime Properties
  ('fl333331-3333-3333-3333-333333333331', 'AYCL-Proposal-PrimeProperties-v1.pdf', 'application/pdf', 745472, '/files/proposals/AYCL-Proposal-PrimeProperties-v1.pdf', ARRAY['proposal','primeproperties','realestate','declined'], '33333333-3333-3333-3333-333333333333', '('b3333333-3333-3333-3333-333333333331', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '20 days'),
  
  ('fl333332-3333-3333-3333-333333333332', 'AYCL-Proposal-PrimeProperties-v2-revised.pdf', 'application/pdf', 821248, '/files/proposals/AYCL-Proposal-PrimeProperties-v2.pdf', ARRAY['proposal','primeproperties','realestate','revised'], '33333333-3333-3333-3333-333333333333', '('b3333333-3333-3333-3333-333333333331', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '5 days'),
  
  ('fl333333-3333-3333-3333-333333333333', 'Contract-PrimeProperties-AYCL-2024-003-draft.pdf', 'application/pdf', 712704, '/files/contracts/AYCL-2024-003-draft.pdf', ARRAY['contract','draft','primeproperties'], '33333333-3333-3333-3333-333333333333', '('b3333333-3333-3333-3333-333333333331', 'ct333333-3333-3333-3333-333333333331', '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '4 days'),
  
  -- File ShopItaly
  ('fl444441-4444-4444-4444-444444444441', 'AYCL-Proposal-ShopItaly-Ecommerce-v1.pdf', 'application/pdf', 658432, '/files/proposals/AYCL-Proposal-ShopItaly-v1.pdf', ARRAY['proposal','shopitaly','ecommerce'], '44444444-4444-4444-4444-444444444444', '('b4444444-4444-4444-4444-444444444441', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '10 days'),
  
  ('fl444442-4444-4444-4444-444444444442', 'ShopItaly-API-Integration-Guide.pdf', 'application/pdf', 245760, '/files/technical/shopitaly-api-guide.pdf', ARRAY['technical','api','integration','shopitaly'], '44444444-4444-4444-4444-444444444444', '('b4444444-4444-4444-4444-444444444441', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '8 days'),
  
  -- File FinTech Innovations
  ('fl666661-6666-6666-6666-666666666661', 'AYCL-Proposal-FinTech-Innovations-v1.pdf', 'application/pdf', 892928, '/files/proposals/AYCL-Proposal-FinTech-v1.pdf', ARRAY['proposal','fintech','innovations'], '66666666-6666-6666-6666-666666666666', '('b6666666-6666-6666-6666-666666666661', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '2 days'),
  
  ('fl666662-6666-6666-6666-666666666662', 'FinTech-Leads-Sample-Data-GDPR-Compliant.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 156672, '/files/samples/fintech-sample-leads-gdpr.xlsx', ARRAY['sample','leads','fintech','gdpr'], '66666666-6666-6666-6666-666666666666', '('b6666666-6666-6666-6666-666666666661', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '1 day'),
  
  ('fl666663-6666-6666-6666-666666666663', 'AYCL-Case-Study-Fintech-Success-Stories.pdf', 'application/pdf', 2097152, '/files/marketing/aycl-fintech-case-studies.pdf', ARRAY['case_study','fintech','marketing'], '66666666-6666-6666-6666-666666666666', '('b6666666-6666-6666-6666-666666666661', NULL, '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '15 days')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('tkt11111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000002', 'Richiesta aggiornamento database leads Tech', 'Buongiorno, alcuni contatti nel database fornito hanno email non più valide. Possibile avere un refresh parziale?', 'open', 'normal', '00000000-0000-0000-0000-000000000001', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NULL),
  
  -- Ticket da Digital Boost
  ('tkt22222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000002', 'Domanda su prossimo acquisto leads', 'Ciao, vorremmo acquistare un altro pacchetto per campagna LinkedIn. Disponibilità per call questa settimana?', 'solved', 'normal', '00000000-0000-0000-0000-000000000002', NOW() - INTERVAL '5 days', NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days'),
...
VALUES
  ('chk11111-1111-1111-1111-111111111111', 'cs_techflow_enterprise_001', 'a1111111-1111-1111-1111-111111111111', '('b1111111-1111-1111-1111-111111111111', 'completed', '{"payment_method":"bank_transfer","amount":15000}'::jsonb, NOW() - INTERVAL '60 days', NOW() - INTERVAL '60 days'),
  
  ('chk22222-2222-2222-2222-222222222222', 'cs_digitalboost_marketing_001', NULL, '('b2222222-2222-2222-2222-222222222221', 'completed', '{"payment_method":"bank_transfer","amount":8500}'::jsonb, NOW() - INTERVAL '45 days', NOW() - INTERVAL '45 days'),
  
  ('chk33333-3333-3333-3333-333333333333', 'cs_primeproperties_luxury_001', 'a2222222-2222-2222-2222-222222222222', '('b3333333-3333-3333-3333-333333333331', 'pending', '{"payment_method":"bank_transfer","amount":25000}'::jsonb, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days')
ON CONFLICT (id) DO NOTHING;
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '==============================================';
  RAISE NOTICE '✅ SEED DATI REALISTICI COMPLETATO!';
  RAISE NOTICE '==============================================';
  RAISE NOTICE 'Azienda: AYCL - Lead Generation & Sales';
  RAISE NOTICE '';
  RAISE NOTICE '📊 Riepilogo dati inseriti:';
  ...
  RAISE NOTICE '';
  RAISE NOTICE '💰 Metriche Pipeline:';
  RAISE NOTICE '  - Pipeline Value: €119,000';
  RAISE NOTICE '  - Won Value: €29,000';
  RAISE NOTICE '  - Pending Value: €90,000';
  RAISE NOTICE '  - Win Rate: 75% (3 won, 1 lost)';
  RAISE NOTICE '';
  RAISE NOTICE '🎯 La dashboard ora mostrerà dati realistici!';
  RAISE NOTICE '==============================================';
END $$;
